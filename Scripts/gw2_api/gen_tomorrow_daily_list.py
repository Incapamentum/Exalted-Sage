"""
    ...
    File name: gen_tomorrow_daily_list.py

    Generates a list of tomorrow's dailies at
    the time of script execution.

    The list of tomorrow's daily achievements
    changes upon server reset, which occurs
    at 00:00 UTC
"""
...
fp.close()
print("List of tomorrow's dailies have been generated and saved within 'logs' subdirectory.")